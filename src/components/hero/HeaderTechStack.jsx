...
import { SiDjango, SiVisualstudio, SiLaravel, SiDotnet, SiAndroidstudio } from "react-icons/si";
      ...
      >
        <motion.li variants={animation}>
          <div className="transition duration-200 hover:text-[#3e9c3e]">
            <SiDjango className="h-6 w-6 md:h-8 md:w-8" />
          </div>
        </motion.li>
        <motion.li variants={animation}>
        ...
        <motion.li variants={animation}>
          <div className="transition duration-200 hover:text-[#6e50c2]">
            <SiDotnet className="h-6 w-6 md:h-8 md:w-8" />
          </div>
        </motion.li>
        <motion.li variants={animation}>
        ...
        <motion.li variants={animation}>
          <div className="transition duration-200 hover:text-[#6e50c2]">
            <SiVisualstudio className="h-6 w-6 md:h-8 md:w-8" />
          </div>
        </motion.li>
        <motion.li variants={animation}>
          <div className="transition duration-200 hover:text-[#6e50c2]">
            <SiAndroidstudio className="h-6 w-6 md:h-8 md:w-8" />
          </div>
        </motion.li>
      </motion.ul>
    </div>
